...
<div class="blur">
    ...
    <ul>
            ...
            <li><a class="active" href="uumAssessment-B.php?matricNo=' . $matricNo . '">SECTION B</a></li>
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
            ...
            $result = mysqli_query($db, "INSERT INTO totalc (matricNo,q18,q19,q20)
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
                    ...
                    ?>
                            ...
                            <td colspan="5"> <?php echo  $q18 .  " + " . $q19 . " + " . $q20; ?>
                            </td>
                </tr>
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
        ...
        $result = mysqli_query($db, "INSERT INTO totald (matricNo,q21,q22,q23,q24)
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
                ...
                ?>
                        ...
                        <td colspan="5"> <?php echo  $q21 .  " + " . $q22 . " + " . $q23 . " + " . $q24; ?>
                        </td>
            </tr>
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
        ...
        $result = mysqli_query($db, "INSERT INTO totale (matricNo,q25,q26,q27,q28,q29,q30)
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
                ...
                ?>
                        ...
                        <td colspan="5"> <?php echo  $q25 .  " + " . $q26 . " + " . $q27 . " + " . $q28 . " + " . $q29 . " + " . $q30; ?>
                        </td>
            </tr>
        ...
        <tr>
            ...
            <?php
                    ...
                    if (isset($_POST['calculateE'])) {
                        ...
                        $totalE = (($q25 + $q26 + $q27 + $q28 + $q29 + $q30) * 3) / 24;
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
        ...
        $result = mysqli_query($db, "INSERT INTO totalf (matricNo,q31,q32,q33,q34,q35)
                    VALUES ('$matricNo', '0', '0', '0', '0', '0')");
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
                ...
                ?>
                        ...
                        <td colspan="5"> <?php echo  $q31 .  " + " . $q32 . " + " . $q33 . " + " . $q34 . " + " . $q35; ?>
                        </td>
            </tr>
        ...
        <tr>
            ...
            <?php
                    ...
                    if (isset($_POST['calculateF'])) {
                        ...
                        $totalF = (($q31 + $q32 + $q33 + $q34 + $q35) * 4) / 20;
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
        ...
        $result = mysqli_query($db, "INSERT INTO totalg (matricNo,q36,q37,q38,q39)
                    VALUES ('$matricNo', '0', '0', '0', '0')");
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
            ...
            '
                ...
                ?>
                        ...
                        <td colspan="5"> <?php echo  $q36 .  " + " . $q37 . " + " . $q38 . " + " . $q39; ?>
                        </td>
            </tr>
    ...
    <div class="topnav">
        ...
        <div class="search-container">
            <button type='submit' name="calculateG" id="calculateG">
                ...
                <br>
                        <?php
            echo '  <button> <a style="text-decoration:none;color:Black;padding-right:18px;padding-left:18px;" href="uumAssessment-C.php?matricNo=' . $matricNo . '" 
            class="next">Next </a> </button>'
            ?>
            <br>
                        <?php
            echo '  <button> <a style="text-decoration:none;color:Black;padding-right:3px;padding-left:3px;" href="uumAssessment-A.php?matricNo=' . $matricNo . '" 
