...
<ul>
            <?php
            echo'
            <li><a href="uumAssessment-A.php?matricNo=' . $matricNo . '">SECTION A</a></li>
            <li><a href="uumAssessment-B.php?matricNo=' . $matricNo . '">SECTION B</a></li>
            <li><a class="active" href="uumAssessment-C.php?matricNo=' . $matricNo . '">SECTION C</a></li>
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
            ...
            $result = mysqli_query($db, "INSERT INTO totalh (matricNo,q40,q41,q42,q43,q44,q45)
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
                    ...
                    ?>
                            ...
                            <td colspan="5"> <?php echo  $q40 .  " + " . $q41 . " + " . $q42 .
                                                    " + " . $q43 . " + " . $q44 . " + " . $q45; ?>
                            </td>
                </tr>
            ...
            <tr>
                ...
                <?php
                        ...
                        if (isset($_POST['calculateH'])) {
                            ...
                            $totalH = (($q40 + $q41 + $q42 + $q43 + $q44 + $q45) * 4) / 24;
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
        ...
        $result = mysqli_query($db, "INSERT INTO totali (matricNo,q46,q47,q48)
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if (isset($_POST['calculateI'])) {
                        ...
                        $I = "UPDATE totali 
                                ...
                                q48 = '$q48'
                                WHERE matricNo = $matricNo";
                        $insert = mysqli_query($db, $I);
                ?>

                        <td colspan="5"> <?php echo  $q46 .  " + " . $q47 . " + " . $q48; ?>
                        </td>
            </tr>
    ...
    <tr>
        ...
        <?php
                    ...
                    if (isset($_POST['calculateI'])) {
                        ...
                        $totalI = (($q46 + $q47 + $q48) * 4) / 12;

                        $roundI = number_format((float)$totalI, 2, '.', '');

                        $sql = "UPDATE uumassessment 
                                    SET totalI = '$roundI' WHERE matricNo = '$matricNo' ";
                        $insert = mysqli_query($db, $sql);
                        $sql2 = "UPDATE student
                                    SET status = 'Unconfirmed', feedback=' ' WHERE studMatricNo = '$matricNo' ";
                                    $insert2 = mysqli_query($db, $sql2);
            ?>
                ...
                <td colspan="5"><?php echo number_format((float)$totalI, 2, '.', '') ?>
                </td>
            <?php } ?>
        </tr>
    ...
    <div class="topnav">
        ...
        <div class="search-container">
            <button type='submit' name="calculateI" id="calculateI">
                Calculate</button>
        </div>
    </div>
</form>
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
        ...
        $result = mysqli_query($db, "INSERT INTO totalj (matricNo,q49,q50,q51,q52,q53,q54,q55)
                    VALUES ('$matricNo', '0', '0', '0', '0', '0', '0','0')");
    ...
    <tr>
        <td> 
            <b>Graphics (charts, tables, graphs) </b>
        </td>
        <td style="font-weight:normal">
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if (isset($_POST['calculateJ'])) {
                        ...
                        $J = "UPDATE totalj 
                                ...
                                q55 = '$q55'
                                WHERE matricNo = $matricNo";
                        $insert = mysqli_query($db, $J);
                ?>

                        <td colspan="5"> <?php echo  $q49 .  " + " . $q50 . " + " . $q51 . 
                        " + " . $q52 . " + " . $q53 . " + " . $q54 . " + " . $q55; ?>
                        </td>
            </tr>
    ...
    <tr>
        ...
        <?php
                    ...
                    if (isset($_POST['calculateJ'])) {
                        ...
                        $totalJ = (($q49 + $q50 + $q51 + $q52 + $q53 + $q54 + $q55) * 10) / 28;

                        $roundJ = number_format((float)$totalJ, 2, '.', '');
                        
                        $sql = "UPDATE uumassessment 
                                    SET totalJ = '$roundJ' WHERE matricNo = '$matricNo' ";
                        $insert = mysqli_query($db, $sql);
                        $sql2 = "UPDATE student
                                    SET status = 'Unconfirmed', feedback=' ' WHERE studMatricNo = '$matricNo' ";
                                    $insert2 = mysqli_query($db, $sql2);
            ?>
                ...
                <td colspan="5"><?php echo number_format((float)$totalJ, 2, '.', '') ?>
                </td>
            <?php } ?>
        </tr>
    ...
    <div class="topnav">
        ...
        <div class="search-container">
            <button type='submit' name="calculateJ" id="calculateJ">
                Calculate</button>
        </div>
    </div>
</form>
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
        ...
        $result = mysqli_query($db, "INSERT INTO totalk (matricNo,q56)
                    VALUES ('$matricNo', '0')");
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if (isset($_POST['calculateK'])) {
                        ...
                        $K = "UPDATE totalk 
                                ...
                                q56 = '$q56'
                                WHERE matricNo = $matricNo";
                        $insert = mysqli_query($db, $K);
                ?>

                        <td colspan="5"> <?php echo  $q56; ?>
                        </td>
            </tr>
    ...
    <tr>
        ...
        <?php
                    ...
                    if (isset($_POST['calculateK'])) {
                        ...
                        $roundK = number_format((float)$totalK, 2, '.', '');

                        $sql = "UPDATE uumassessment 
                                    SET totalK = '$roundK' WHERE matricNo = '$matricNo' ";
                        $insert = mysqli_query($db, $sql);
                        $sql2 = "UPDATE student
                                    SET status = 'Unconfirmed', feedback=' ' WHERE studMatricNo = '$matricNo' ";
                                    $insert2 = mysqli_query($db, $sql2);
            ?>
                ...
                <td colspan="5"><?php echo number_format((float)$totalK, 2, '.', '') ?>
                </td>
            <?php } ?>
        </tr>
    ...
    <div class="topnav">
        ...
        <div class="search-container">
            <button type='submit' name="calculateK" id="calculateK">
                Calculate</button>
                 <br>
                        <?php
            echo '  <button> <a style="text-decoration:none;color:Black;padding-right:18px;padding-left:18px;" href="uumAssessmentTotal.php?matricNo=' . $matricNo . '" 
            class="next">Next </a> </button>'
            ?>
            <br>
                        <?php
            echo '  <button> <a style="text-decoration:none;color:Black;padding-right:3px;padding-left:3px;" href="uumAssessment-B.php?matricNo=' . $matricNo . '" 
