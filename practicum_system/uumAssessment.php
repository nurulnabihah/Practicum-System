    ...
    <div class="blur">
        ...
        <div class="topnav">
            ...
            <div class="search-container">
                ...
                <form action="uumAssessment.php" method="post">
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
                ...
                if (isset($_POST['search'])) {
                    ...
                    $query = "SELECT * FROM studentdetail WHERE uumSName LIKE 
     ...
     OR matricNo='$searchNM'";
                ...
                <td style="text-align: center;"> <a href="uumAssessment-A.php?matricNo=' . $row["matricNo"] . '" 
               ...
               ';
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo '
                <tr>
                <td style="text-align: center;" id="matricNo" name="matricNo" >' . $row["matricNo"] . '</td>
                <td style="text-align: center;">' . $row["name"] . '</td>
                <td style="text-align: center;"> <a href="uumAssessment-A.php?matricNo=' . $row["matricNo"] . '" 
                id="matricNo" name="update" >UPDATE
                <i class="fas fa-edit" style="font-size:22px"></a>     
