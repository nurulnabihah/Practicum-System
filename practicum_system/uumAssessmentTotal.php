...
<body>
    <div class="blur">
        ...
        <ul>
            ...
            <li><a class="active" href="uumAssessmentTotal.php?matricNo=' . $matricNo . '">TOTAL</a></li>
            '; ?>
        </ul>
        ...
        ?>
                    ...
                    <tr>
                        ...
                        <?php
                            ...
                            $sql = "UPDATE uumassessment 
                                    SET grandTotal = '$roundGrand', grandHundred = '$roundGrand100' WHERE matricNo = '$matricNo' ";
                            $insert = mysqli_query($db, $sql);
                        
                            $sql1 = "UPDATE student
                                    SET uumMarks = '$roundGrand', uumHundred = '$roundGrand100' WHERE studMatricNo = '$matricNo' ";
                        $insert1 = mysqli_query($db, $sql1);
            ...
            <div class="topnav">
                ...
                <div class="search-container">
                        <?php
            echo '  <button> <a style="text-decoration:none;color:Black;padding-right:3px;padding-left:3px;" href="uumAssessment-C.php?matricNo=' . $matricNo . '" 
