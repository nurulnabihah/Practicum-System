...
<body>
    <div class="blur">
        ...
        <ul>
            ...
            <li><a class="active" href="viewCompany-B.php?matricNo=' . $matricNo . '">SECTION B</a></li>
 ...
 ?>
        ...
        <div class="topnav">
            ...
            <div class="search-container">
                        <?php
            echo '  <button> <a style="text-decoration:none;color:Black;padding-right:18px;padding-left:18px;" href="viewCompanyTotal.php?matricNo=' . $matricNo . '" 
            class="next">Next </a> </button>'
            ?>
            <br>
                        <?php
            echo '  <button> <a style="text-decoration:none;color:Black;padding-right:3px;padding-left:3px;" href="viewCompany-A.php?matricNo=' . $matricNo . '" 
