...
<body>
    <div class="blur">
        ...
        <ul>
            <?php
            echo'
            <li><a class="active" href="viewUUM-A.php?matricNo=' . $matricNo . '">SECTION A</a></li>
    ...
    FROM
        ...
        ?>
            ...
            <div class="container1">
                <p class="ex1">
                    This evaluation contributes 60% of the total marks for practicum from UUM Supervisor.<br>
                        <br>
...
$db = mysqli_connect('localhost', 'saujanae_adminPracticumSystem', 'oRK8W$A}gg.(', 'saujanae_practicum_system');
            ...
            <div class="topnav">
                ...
                <div class="search-container">
                        <?php
            echo '  <button> <a style="text-decoration:none;color:Black;padding-right:18px;padding-left:18px;" 
            href="viewUUM-B.php?matricNo=' . $matricNo . '" 
